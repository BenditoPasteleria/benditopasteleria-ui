...
const Footer = () => {
	...
	return (
		<footer className="bg-bendito-primary text-bendito-secondary mt-12">
			<div className="max-w-7xl mx-auto px-4 py-8 pb-24 sm:pb-8">
				...
				<div className="text-center mb-6">
					...
					<p className="text-bendito-secondary/70 text-xs">
				...
				<div className="text-center border-t border-bendito-secondary/20 pt-4">
					<p className="text-bendito-secondary/60 text-xs">
